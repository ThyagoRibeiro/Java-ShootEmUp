...
public class ActivePlayerState implements EntityState {
	...
	public void render() {
		...
		GameLib.drawPlayer(context.getPosition().getX(), context.getPosition()
	...
	public void update() {
		...
		} else if (context.getPosition().getX() > GameLib.WIDTH
				- context.getRadius()) {
		...
		} else if (context.getPosition().getY() > GameLib.HEIGHT
				- context.getRadius()) {
